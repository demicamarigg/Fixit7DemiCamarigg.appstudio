...
const cacheName = 'Fixit7DemiCamarigg-2020-09-30 14:28:45.155963'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'Fixit7DemiCamarigg'.length) === 'Fixit7DemiCamarigg') {
